...
(function run() {
  ...
  const introOnlyAnchors = [
    '当前版本重点（V10 真 PVP · 前端焕新）',
    '当前迭代重点（V10 真 PVP · 前端焕新）',
    'PVP 风险画像已上线',
  ...
  const currentVersionPattern = /V10 真 PVP · 前端焕新/g;
  ...
  assert(introVersionCount >= 2, `expected intro to mention V10 真 PVP · 前端焕新 at least twice, got ${introVersionCount}`);
  assert(progressVersionCount >= 1, `expected progress to mention V10 真 PVP · 前端焕新 at least once, got ${progressVersionCount}`);
