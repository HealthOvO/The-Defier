...
(function run() {
  ...
  game.lastRunPathRewardMeta = {
    ...
    entries: [
      { phaseId: 'insight_opening', phaseLabel: '命引', title: '窥见真机', rewardText: '最大生命值+5', completed: true },
      { phaseId: 'insight_middle', phaseLabel: '命定', title: '无形之线', rewardText: '抽牌数+1', completed: true },
      { phaseId: 'insight_climax', phaseLabel: '命劫', title: '宿命断点', rewardText: '初始法力+1', completed: true }
    ]
  };
  game.autoSave = () => {};
  ...
  game.rewardView.continueAfterReward();
