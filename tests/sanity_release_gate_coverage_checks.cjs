...
[
  ...
  'postMatchReview|settlementReport|seasonHonorReport|cosmeticReward|seasonHonorCollection|collectionState|viewerSeat',
...
[
  ...
  'live UI should unlock realtime intent after authoritative stateVersion advances',
