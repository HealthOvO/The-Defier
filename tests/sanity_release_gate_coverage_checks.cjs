...
[
  ...
  [authoritativeRunsEngine, "metric: 'roleSequence'"],
...
[
  ...
  'prod live ranked lethal post-keepalive refresh',
  'recoverable authoritative race',
  ...
  'prod live ranked lethal settlement should expose player-readable reason lines',
  'prod live ranked lethal settlement should explain finish type',
  'prod live ranked lethal settlement should explain score delta',
  'prod live ranked lethal settlement should explain reward boundary',
  'prod live ranked lethal settlement reasons should not use hidden information',
  'prod live ranked lethal settlement copy should not leak hidden rating or raw protocol tokens',
  'prod live ranked lethal settlement report should not expose hidden rating fields',
...
[
  ...
  'terminal projection and UI summarize real combat tactic opportunities and advanced successes',
...
[
  ...
  'data-live-settlement-reason',
  'settlementReasonForbiddenPattern',
  ...
  'data-live-action-status-mitigation',
  'data-live-action-status-mitigation-state',
  'data-live-action-status-mitigation-target',
  'data-live-action-status-mitigation-by',
  'data-live-action-status-mitigation-response-window',
  'data-live-action-status-mitigation-safeguard',
  ...
  'data-live-action-budget-clamp',
  'public_first_action_budget',
  'data-live-action-opening-protection',
  'public_opening_protection',
  'public_damage_survival',
  'data-live-action-survival',
  'data-live-action-survival-target',
  'data-live-action-survival-hp-after',
  'data-live-action-survival-source',
  'data-live-action-survival-hidden',
  'data-live-action-survival-impact',
  'public_terminal_damage',
  'data-live-action-terminal',
  'data-live-action-terminal-target',
  'data-live-action-terminal-hp-after',
  'data-live-action-terminal-source',
  'data-live-action-terminal-hidden',
  'data-live-action-terminal-impact',
  'public_turn_handoff',
  'data-live-action-turn-handoff',
  'data-live-action-turn-handoff-next-seat',
  'data-live-action-turn-handoff-draw-count',
  'data-live-action-turn-handoff-counterplay-block',
  'data-live-action-turn-handoff-source',
  'data-live-action-turn-handoff-hidden',
  'data-live-action-turn-handoff-impact',
  ...
  'data-live-opening-protection',
  'data-live-opening-counterplay',
  '防先手秒杀',
  '后手行动窗口',
  '先手预算 18',
  '后手预算 24',
  ...
  'status_response_handoff',
  'public_status_handoff_risk',
  'data-live-action-handoff-risk',
  'data-live-action-handoff-risk-state',
  'data-live-action-handoff-risk-source',
  'data-live-action-handoff-risk-hidden',
  'data-live-action-handoff-risk-impact',
  'data-live-action-handoff-risk-status-count',
  'live UI renders action handoff risk receipt after status-response end turn',
  'public_status_consumed',
  'data-live-action-status-payoff',
  'data-live-action-status-payoff-state',
  'data-live-action-status-payoff-source',
  'data-live-action-status-payoff-hidden',
  'data-live-action-status-payoff-impact',
  'data-live-action-status-payoff-bonus',
  'data-live-action-status-payoff-safeguard',
...
[
  ...
  'friendlyRematchActivation.realTapAttempts',
  'friendlyRematchActivation.realTapRetryActionables',
  ...
  'cardInstanceId|sourceCardId|cardId|instanceId|\\bhand\\b|hand":\\[|deck|loadoutSnapshot|reward|rating|elo|token|opponentHand|opponentDeck',
  ...
  'naturalLoserProbe.fairnessState',
  'naturalLoserProbe.effectiveActionState',
  ...
  'focused real browser post-match safety exit smoke has no console errors',
  'postSafetyExitProbe.disputeHidden',
  'postSafetyExitProbe.avoidSafeguard',
  'postMatchParity',
  ...
  'data-live-action-handoff-risk="status_response_handoff"',
  'public_status_handoff_risk',
  ...
  'data-live-action-status-payoff="vulnerable_mark"',
  'public_status_consumed',
  'data-live-action-status-mitigation="vulnerable_mark"',
  'public_status_mitigated',
  'status_mitigated',
  'data-live-fairness-receipt',
...
[
  ...
  'live-ops-token:',
  'LIVE_OPS_FORBIDDEN_AGGREGATE_KEYS',
  'makeLiveOpsOverview',
  'fairnessDisputeRows',
  'retentionPreview',
  'pvp-live-ops-overview-v1',
...
[
  ...
  'live ops overview should be disabled without a configured token',
  'live ops overview should require the live ops token even with bearer auth',
  'live ops overview should reject invalid ops credentials',
  ...
  'live ops overview should require and accept the live ops token',
  'pvp-live-ops-overview-v1',
  'forbiddenLiveOpsAggregatePattern',
  'live ops fairness metrics must sanitize aggregate bucket keys',
  'live ops overview should reuse the fairness dispute summary',
  'live ops overview should reuse the fairness avoidance summary',
  'live ops overview dispute queue should include open backlog outside the fairness window',
  'live ops overview should align with retention dry-run state-signal preview',
...
[
  ...
  'loser settlement report should explain the finish type in player-readable copy',
  'loser settlement report should explain why score changed',
  'loser settlement report should explain reward and non-power boundary',
  'settlement reason lines must not use hidden information',
  'settlement reasons must not expose hidden rating or raw settlement protocol values',
  'reasonLines',
...
[
  ...
  'settlementReasonSources',
  'settlementReasonImpacts',
  'settlementReasonLayout',
  'data-live-settlement-reason',
  'settlementReasonCopyForbiddenPattern',
  'settlementReportHiddenForbiddenPattern',
  'settlementReasonCopyHaystack',
  'settlementReportHiddenHaystack',
  'usesHiddenInformation === false',
  ...
  "queueCancelCycles.every(cycle => cycle.joinActionable?.ok === true && cycle.cancelActionable?.ok === true)",
  ...
  "queueCancelCooldownPracticeActionable?.ok === true",
