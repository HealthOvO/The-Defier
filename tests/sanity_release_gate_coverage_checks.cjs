...
[
  ...
  'artifact action bridge must not claim an unimplemented report_issue UI handoff',
  'artifact post-game action coverage should only contain implemented public review UI actions',
...
[
  ...
  'S2-C full gate action bridge must not claim an unimplemented report_issue UI handoff',
  'S2-C full gate post-game action coverage should only contain implemented public review UI actions',
...
[
  ...
  'live emote buttons should only be disabled while a social realtime intent is pending',
...
[
  ...
  'live UI local disconnected state prefers authoritative sync guidance before connection_timeout',
