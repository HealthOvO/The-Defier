...
async function runChecks() {
  ...
  try {
    ...
    assert.strictEqual(upgradedVersion.payload?.schema?.currentMigrationId, '0007_authoritative_challenge_ladder', 'older databases should advance through verified runs to challenge ladder v7 on restart');
    assert.deepStrictEqual(
