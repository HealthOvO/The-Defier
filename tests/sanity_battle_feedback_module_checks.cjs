...
(function run() {
  ...
  assert(typeof feedback.BattleFeedback.escapeHtml === 'function', 'escapeHtml should exist');
  assert(feedback.BattleFeedback.escapeHtml('<boss>') === '&lt;boss&gt;', 'escapeHtml should encode angle brackets');
