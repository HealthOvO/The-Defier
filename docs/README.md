...
- `backend_authoritative_runs_v2.md`: PVE、挑战和远征的服务端权威试炼 V2，包含确定性状态机、命令协议、动作哈希链、快照恢复、完整重放结算、路线合同、章节分岔、敌意反制题面、持续敌方格挡、旧内容快照兼容、SQLite V6、账号隔离、运维与保留策略；旧玩法仍保留观察/可信兼容边界。
