...
- S8K 已补 active match same-version content conflict guard，S8Q 已补同版本同内容 connection timeline 单调合并，但这仍不是完整 active match revision/CAS；Redis / 多实例强一致队列、跨进程 WS fanout、生产 smoke 和线上部署仍未封板。
