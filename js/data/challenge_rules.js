  ...
  weekly: [{
    ...
    rewardTrack: [{
      ...
      rewards: [{
        ...
        kind: 'codexRecord',
        id: 'weekly_breaking_tide_record',
        name: '观星台·断潮局',
        icon: '🌊',
        note: '七日劫数已累计穿过双章节，观星台记下断潮局样本。'
      }]
    }, {
      id: 'weekly_score_860',
      label: '周积分 860',
    ...
    rewardTrack: [{
      ...
      rewards: [{
        ...
        kind: 'codexRecord',
        id: 'weekly_sealed_forge_record',
        name: '观星台·封炉谱',
        icon: '⚒️',
        note: '七日劫数的炼器样本已入档，可在观星台复盘。'
      }]
    }, {
      id: 'weekly_score_860',
      label: '周积分 860',
...
if (typeof window !== 'undefined') {
  window.CHALLENGE_RULES = CHALLENGE_RULES;
}
