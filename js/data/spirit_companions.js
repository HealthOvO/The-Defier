...
export const SPIRIT_COMPANIONS = {
  ...
  emberCrow: {
    ...
    tiers: [{
      ...
      chargeMax: 5,
      passive: {
        onLoseHpRandomDamage: 4,
        onLoseHpExtraCharge: 1
      },
      active: {
        type: 'blood_flare',
        selfDamage: 4,
  ...
  artifactSoul: {
    ...
    tiers: [{
      ...
      chargeMax: 6,
      passive: {
        treasureOpeningBlockPerTreasure: 3,
        treasureStartCharge: 1
      },
      active: {
        type: 'relic_overclock',
        gainEnergy: 1,
        block: 6,
        gainCommandPoints: 2
      }
      ...
      chargeMax: 6,
      passive: {
        treasureOpeningBlockPerTreasure: 4,
        treasureStartCharge: 2
      },
      active: {
        type: 'relic_overclock',
        gainEnergy: 2,
