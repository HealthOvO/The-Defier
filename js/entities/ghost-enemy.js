import { AIController } from "../core/ai-controller.js";
...
export class GhostEnemy {
  constructor(data) {
    ...
    this.energy = typeof data.energy === 'number' && !isNaN(data.energy) ? data.energy : this.maxEnergy;
  ...
  async applyEffectReal(effect, battle) {
    ...
    switch (effect.type) {
      ...
      case 'setStance':
        ...
        break;
      case 'removeBlock':
        if (effect.target === 'self') me.block = 0;else player.block = 0;
        break;
      case 'selfDamage':
        {
...
// module.exports = GhostEnemy; else {}