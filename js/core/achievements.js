...
import { ACHIEVEMENTS, getTotalAchievementsCount } from "../data/achievements.js";
...
export class AchievementSystem {
  ...
  getProgress() {
    ...
    const completed = this.unlockedAchievements.filter(id => ACHIEVEMENTS[id] && !ACHIEVEMENTS[id].hidden).length;
    return {
      completed,
      total
    };
