export class FateRingView {
    ...
    showFateRing() {
        ...
        if (ringSystem.children.length === 0) {
            ...
            ring.slots.forEach((slot, index) => {
                ...
                // Click Interaction
                slotEl.onclick = (e) => this.game.handleSlotClick(index, e);
        ...
        rightPanel.innerHTML = `
            <div class="panel-tabs">
                <div class="tab active" onclick="game.switchRingTab(this, 'library')">法则库 (${this.game.player.collectedLaws.length})</div>
    ...
    showEvolutionSelection(targetTier) {
        ...
        const availablePaths = Object.values(FATE_RING.paths).filter(path =>
            ...
            (!path.requires || path.requires.includes(this.game.player.fateRing.path))
        );
...
if (typeof window !== 'undefined') {
    window.FateRingView = FateRingView;
}
